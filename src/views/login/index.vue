  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="false" label-position="left">
      <div class="title-container">
        ...
        <lang-select v-if="isLangSelect" class="set-language" />
      </div>
      ...
      <el-form-item prop="username">
        ...
        <el-input v-model="loginForm.username" :placeholder="$t('login.username')" name="username" type="text" auto-complete="false" />
      </el-form-item>
...
export default {
  ...
  data() {
    const validateUsername = (rule, value, callback) => {
      if (!checkRate(value)) {
        callback(new Error(this.$i18n.t('login.errorEmptyUserName')))
      } else {
        callback()
      }
    }

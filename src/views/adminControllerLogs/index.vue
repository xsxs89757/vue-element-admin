<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-if="checkPermission('adminControllerLogs.clearAdminLogs')" v-waves class="filter-item" type="primary" icon="el-icon-delete" @click="handleDelete">{{ $t('table.clear') }}</el-button>
    </div>
...
<script>
import { getAdminControllerLogs, clearAdminControllerLogs } from '@/api/adminUsers'

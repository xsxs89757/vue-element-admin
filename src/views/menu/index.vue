  ...
  <div>
    <div class="app-container">
      <div class="filter-container">
        ...
        <el-button v-if="checkPermission('menu.addMenu')" v-waves class="filter-item" icon="el-icon-plus" type="primary" @click="handleAddMenu">{{ $t('table.add') }}</el-button>
        <el-button v-if="checkPermission('menu.sortMenu')" v-waves :loading="sortLoading" class="filter-item" icon="el-icon-sort" type="primary" @click="handleSortMenu">{{ $t('table.sort') }}</el-button>
      </div>
      <el-table
        ref="TreeTable"
      ...
      >
        ...
        <el-table-column :label="$t('table.actions')" width="250">
          <template slot-scope="scope">
            ...
            <el-button v-if="checkPermission('menu.editMenu')" size="mini" type="success" @click="handleEdit(scope.row)">{{ $t('table.edit') }}</el-button>
            <el-button v-if="checkPermission('menu.deleteMenu')" size="mini" type="danger" @click="handleDelete(scope.row)">{{ $t('table.delete') }}</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
import { getMenu, deleteMenu, updateMenu, addMenu, updateMenuSort } from '@/api/menu'
